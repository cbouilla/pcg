...
problematic consequences (barring the obvious case where they are used in lieu
of their cryptographic counterparts). When they are used in scientific computing
for Monte-Carlo simulations, their defects have the potential to alter the
results of the simulations. Ferrenberg et al.~\cite{Ferrenberg92} ran a
