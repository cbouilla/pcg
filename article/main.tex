...
\begin{table}[htbp!]
  ...
  \begin{tabular}{|c|Sc|Sc|c|}
	\hline
	n & $\vvvert H \vvvert \times \left\vvvert H^{-1} \right\vvvert$ & $ \lambda_1(\mathcal{L}) $ & minimum $t$ \\
	\hline
...
progression knowing the \(t=\ell+6\) upper bits. Looking at table~\ref{tab:babai}, we see that the best choice
